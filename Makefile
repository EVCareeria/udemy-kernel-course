FILES = ./build/kernel.asm.o ./build/kernel.o ./build/disk/disk.o ./build/keyboard/classic.o ./build/keyboard/keyboard.o ./build/isr80h/misc.o ./build/isr80h/isr80h.o ./build/isr80h/io.o ./build/task/process.o ./build/task/tss.asm.o ./build/task/task.asm.o ./build/task/task.o ./build/disk/streamer.o ./build/fs/pparser.o ./build/fs/file.o ./build/fs/fat/fat16.o ./build/string/string.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o  ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/gdt/gdt.o ./build/gdt/gdt.asm.o
INCLUDES = -I./src
FLAGS = -g -ffreestanding -falign-jumps -falign-functions -falign-labels -falign-loops -fstrength-reduce -fomit-frame-pointer -finline-functions -Wno-unused-function -fno-builtin -Werror -Wno-unused-label -Wno-cpp -Wno-unused-parameter -nostdlib -nostartfiles -nodefaultlibs -Wall -O0 -Iinc

all: ./bin/boot.bin ./bin/kernel.bin $(FILES) user_programs
		rm -rf ./bin/os.bin	
